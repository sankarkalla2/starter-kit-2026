          ...
          <div className="grid items-center gap-16 lg:grid-cols-2">
            <div>
              <div className="mr-auto ml-auto text-center lg:ml-0 lg:max-w-lg lg:text-left [&>p]:mx-auto [&>p]:max-w-xl">
                ...
                <p className="text-muted-foreground mt-4 text-lg/8">
                  Sed eu quam id quam tristique pharetra a at tortor veil
                  dolarto. Suspendisse lorem odio sit amet libero facilisis.
                </p>
            ...
            <div>
              <img
                ...
                src="https://k8boaqmtfy4jtiib.public.blob.vercel-storage.com/stock/heroes-2-1.webp"
                alt="#"
              />
            </div>
          </div>
